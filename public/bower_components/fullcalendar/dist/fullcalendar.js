...
Handling of these markers is done in a category-processing step at the very end of text rendering.
*/
...
- fakeFormatString: a momentJS formatting string, littered with special control characters that get category-processed.
...
characters that will eventually be given to moment for formatting, and then category-processed.
*/
    ...
    for (i = 0; i < chunks.length; i++) {
        ...
        if (typeof chunk === 'string') {
            ...
            if (chunk.token in specialTokens) {
                parts.push(SPECIAL_TOKEN_MARKER + // useful during category-processing
            ...
            parts.push(MAYBE_MARKER + // useful during category-processing
...
// ---------------------------------------------------------------------------------------------------------------------
/*
Formats a date with a fake format string, category-processes the control characters, then returns.
*/
function renderFakeFormatString(fakeFormatString, date) {
    return processMaybeMarkers(renderFakeFormatStringParts(fakeFormatString, date).join(''));
}
/*
Formats a date into parts that will have been category-processed, EXCEPT for the "maybe" markers.
*/
